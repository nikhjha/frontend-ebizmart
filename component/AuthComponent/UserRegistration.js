...
import { RegistrationForm } from "../authentication/userRegister";
import AuthSocial from "../authentication/AuthSocial";
import Image from "next/image";
import { userRegistration } from "../../constant/constant";
    ...
    <RootStyle title="Register | Minimal-UI">
      ...
      <Container>
        <ContentStyle>
          ...
          <AuthSocial action={userRegistration} setError={setError} />
          ...
          <MHidden width="smUp">
            <Typography variant="subtitle2" sx={{ mt: 3, textAlign: "center" }}>
              Already have an account?&nbsp;
              <RouterLink href="/user/login" sx={{ cursor: "pointer" }}>
